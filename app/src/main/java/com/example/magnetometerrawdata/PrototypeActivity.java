...
public class PrototypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scale = 170.0f;
        offsetX = -2000;           //smartphone: left right
        offsetY = -2850;        //smartphone: down-up
        ...
        sensorManager.registerListener(magnetSensorListener, sensorManager.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD), 100000)        ;
